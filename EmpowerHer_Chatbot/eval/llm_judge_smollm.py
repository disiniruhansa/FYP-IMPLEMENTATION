"""
LLM judge for chatbot responses using HuggingFaceTB/SmolLM2-1.7B-Instruct.

Usage (from repo root):
  python -m eval.llm_judge_smollm
...
Outputs:
  - eval/llm_judge_results_smollm.csv

Optional environment variables:
  - LLM_JUDGE_SMOLLM_MODEL (default: HuggingFaceTB/SmolLM2-1.7B-Instruct)
"""
...
def main() -> None:
    ...
    model_name = os.getenv("LLM_JUDGE_SMOLLM_MODEL", "HuggingFaceTB/SmolLM2-1.7B-Instruct")
    ...
    out.to_csv("eval/llm_judge_results_smollm.csv", index=False)

    print("\nSaved: eval/llm_judge_results_smollm.csv")
    print("Mean scores:")
